                            ...
                            <tr class="text-gray-700 border-b">
                                ...
                                <td class="px-1 py-5 text-sm">
                                    ...
                                    @elseif($order->order_status_id == '4')
                                        <a href="{{ route('member.accept.order', $order->id) }}" class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-button"> Accept </a>
                                        <a href="{{ route('member.reject.order', $order->id) }}" class="px-4 py-2 mt-2 text-left bg-white rounded-xl"> Reject </a>
